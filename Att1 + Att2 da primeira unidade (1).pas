ÿþ{ Programa: Sistema de acesso a atividades de lógica de programação
  Data    : 04/05/2023
  Autor   : Ysterllane }
                   ...
                   Case opAtiv of 
                                ...
                                Writeln('Atividade concluida! Tecle algo para continuar.');
 			      	           ...
 			      	           6: Begin    
															  ClrScr;
                                TextColor(10);
																Writeln('6A XYZ Ltda deu + 20% do valor do salário aos funcionários com tempo => 10 anos e de 10% aos demais.');
                                ...
                                Writeln('Atividade concluida! Tecle algo para continuar.');
												...
												7: Begin    
															  ClrScr;
                                TextColor(10);
																Writeln('7Leia as notas das duas avaliações parciais e mostre a situação do aluno:');
